  ...
  return (
    <div className="space-y-6">
      ...
      {order.shipment && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base font-medium">Suivi d&apos;expédition</CardTitle>
          </CardHeader>
          <CardContent className="space-y-1 text-sm">
            {order.shipment.carrier && <p>Transporteur : {order.shipment.carrier}</p>}
            ...
            <p>Statut : {order.shipment.status}</p>
          </CardContent>
        </Card>
      )}
